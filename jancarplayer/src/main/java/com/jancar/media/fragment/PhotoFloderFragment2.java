...
import com.jancar.media.adpater.MenuPhotoAdapater;
...
public class PhotoFloderFragment2 extends BaseFragment implements
        MenuPhotoAdapater.OnItemClickListener,
    ...
    private MenuPhotoAdapater adapter;
    private boolean isClick = false;

    public static PhotoFloderFragment2 newInstance(Bundle args) {
        PhotoFloderFragment2 musicAlbumFragment = new PhotoFloderFragment2();
        musicAlbumFragment.setArguments(args);
        return musicAlbumFragment;
    }

    public PhotoFloderFragment2() {
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        adapter = new MenuPhotoAdapater(getActivity(), mAdapterList, 3);
