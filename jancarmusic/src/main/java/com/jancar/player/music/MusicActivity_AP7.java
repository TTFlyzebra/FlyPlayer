...
public class MusicActivity_AP7 extends MusicActivity_AP1 {

    private ImageView ac_music_bkimg;

    @Override
    public void setContentView(int layoutResID) {
        super.setContentView(R.layout.activity_music_ap6);
    }
    ...
    protected void upCurrenPlayImage(final Bitmap bitmap) {
        ...
        executor.execute(new Runnable() {
            @Override
            public void run() {
                final Bitmap blurBitmap = bitmap==null? null :BlurUtil.blur(MusicActivity_AP7.this, bitmap);
