...
import com.jancar.media.module.cache.DoubleBitmapCache;
...
public class FileAdapater2 extends RecyclerView.Adapter<FileAdapater2.ViewHolder> {
    ...
    public FileAdapater2(Context context, List<String> list, RecyclerView recyclerView) {
        mContext = context;
        mList = list;
