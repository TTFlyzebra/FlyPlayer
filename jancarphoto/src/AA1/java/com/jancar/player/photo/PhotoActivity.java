...
//        tabView.setTitles(titles);
    ...
    public void notifyPathChange(String path) {
        ...
        Log.e("PhotoActivity", "notifyPathChange");
        if (isStop) return;
        isScan = true;
        imageList.clear();
        mHashSet.clear();
...
//            imageList.clear();
    ...
    public void scanFinish(String path) {
        ...
        adapter.notifyDataSetChanged();
        photoNum = imageList.size();
        photoFloderNum = mHashSet.size();
        updateTabView(floderNum, photoNum, photoFloderNum);
