package com.jancar.photo.adpater;
...
import com.jancar.photo.MainActivity;
...
public class PhotoFloderAdapater extends RecyclerView.Adapter<ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        String crtUrl = ((MainActivity)mContext).CURRENT_IMAGE ==null?"":((MainActivity)mContext).CURRENT_IMAGE.url;
