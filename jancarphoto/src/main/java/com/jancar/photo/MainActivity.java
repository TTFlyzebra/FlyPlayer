        ...
        public void run() {
            ...
            if (time > hideTime && !imageList.isEmpty()) {
                ...
                controlLayout.animate()
                        .translationY(150 * DisplayUtils.getMetrices(MainActivity.this).heightPixels / 600)
        ...
        leftLayout.animate()
                ...
                .setListener(new Animator.AnimatorListener() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                        if (leftLayout.getX() > ((1024 - 394) * DisplayUtils.getMetrices(MainActivity.this).widthPixels / 1024)) {
    ...
    private class MyPageAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if(it.hasNext()) {
                ...
                photoView = new PhotoView(MainActivity.this);
            }
            photoView.setOnClickListener(MainActivity.this);
