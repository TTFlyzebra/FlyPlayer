...
public class PhotoActivity_APA extends PhotoActivity_AP1 {
    @Override
    public void setContentView(int layoutResID) {
        super.setContentView(R.layout.activity_photo_a);
    }
    ...
    protected void setPhotoPlayImg() {
        photoPlay.setImageResource(R.drawable.media_play_photo);
    }

    @Override
    protected void setPhotoPauseImg() {
        photoPlay.setImageResource(R.drawable.media_pause_photo);
    }
